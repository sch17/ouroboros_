...
MODEL_MAIN = get_cfg("OUROBOROS_MODEL", default="google/gemini-2.5-flash", allow_legacy_secret=True)
MODEL_CODE = get_cfg("OUROBOROS_MODEL_CODE", default="google/gemini-2.5-flash", allow_legacy_secret=True)
...
# MODEL_MAIN, MODEL_CODE, MODEL_LIGHT are already set by get_cfg,
# no need to duplicate os.environ setting.
